...
var inputError = createCommonjsModule(function(module) {
  (function() {
    var util2 = util$1;
    function InvalidInputError2(input) {
      this.name = "InvalidInputError";
      if (input) {
        this.message = util2.format('"%s" is not a valid input string for node-roll.', input);
      } else {
        this.message = "No input string was supplied to node-roll.";
      }
      this.input = input;
    }
    InvalidInputError2.prototype = new Error();
    InvalidInputError2.prototype.constructor = InvalidInputError2;
    module.exports = InvalidInputError2;
  })();
});
...
var bestOf = createCommonjsModule(function(module) {
  (function() {
    module.exports = function(rolledDice, value) {
      var result = [], sorted = rolledDice.sort(function(a, b) {
        return b - a;
      }), i;
...
var sum = createCommonjsModule(function(module) {
  (function() {
    module.exports = function(rolledDice) {
      return rolledDice.reduce(function(sum2, value) {
        return sum2 + value;
      }, 0);
    };
  })();
...
var src = createCommonjsModule(function(module) {
  (function() {
    var InvalidInputError2 = inputError, transformationFunctions = transforms, transformationKeys = keys, regex = /^(\d*)d(\d+|\%)(([\+\-\/\*bw])(\d+))?(([\+\-\/\*])(\d+|(\d*)d(\d+|\%)(([\+\-\/\*bw])(\d+))?))*$/, roll, cleaner, sumResult = false, filler = [];
    ...
    roll.prototype.parse = function(s) {
      if (!this.validate(s)) {
        throw new InvalidInputError2(s);
      }
      var match = regex.exec(s), quantity = match[1], sides = match[2], hasTransformation = !!match[3], operator, transformationParameter, transforms2 = [], opIndex = 0, segments = s.split(/[\+\-]/), outsideRoll, seg;
      if (segments[0].indexOf("b") > -1 || segments[0].indexOf("w") > -1) {
        transforms2.push(transformationKeys[match[4]](parseInt(match[5], 10)));
      }
      for (seg = 1; seg < segments.length; seg += 1) {
        ...
        if (transformationParameter.indexOf("d") > -1) {
          ...
          transforms2.push(transformationKeys[operator](outsideRoll.result));
        } else {
          transforms2.push(transformationKeys[operator](parseInt(transformationParameter, 10)));
        }
      }
      return {
        quantity: quantity ? parseInt(quantity, 10) : 1,
        sides: sides === "%" ? 100 : parseInt(sides, 10),
        transformations: hasTransformation || transforms2.length > 0 ? transforms2.length > 0 ? transforms2 : transformationKeys[match[4]](parseInt(match[5], 10)) : ["sum"],
        toString: function() {
          return s;
        }
      };
    ...
    roll.prototype.roll = function(input, invokedByParse) {
      ...
      var rolled = [], calculations = [], carryFiller = [];
      ...
      calculations = input.transformations.reduce(function(previous, transformation) {
        var transformationFunction, transformationAdditionalParameter, sumParam = false;
    ...
    module.exports = roll;
    module.exports.InvalidInputError = InvalidInputError2;
  })();
});
var InvalidInputError = src.InvalidInputError;
export default src;
export {InvalidInputError, src as __moduleExports};
